...
users_table <- combined_data %>% 
  ...
  select(user_id, user_first_name, user_last_name, user_email, user_password, user_mobile_number, user_membership_status)
...
order_details_table <- combined_data %>%
  select(order_detail_id, product_id, order_qty, order_price, order_status, order_datetime, user_id)

...
generate_synthetic_data <- function(n) {
  ...
  product_id <- sample(1000:9999, n, replace = FALSE)  # Random 4-digit values
...
users_table <- combined_data %>% 
  ...
  select(user_id, user_first_name, user_last_name, user_email, user_password, user_mobile_number, user_membership_status, address_id, user_id, address_city, address_country, address_state, address_postcode, address_type)
